...
outputs: void
appends to the frontier all possible next states of the current node cube
*/
...
/*
inputs: memory adress to Cube class instance
outuput: bool
return true if two cubes are the same (same colour pattern)
*/
...
inputs: memory adress to Cube class instance
outuput: bool
return true if two cubes are different (different colour pattern)
*/
bool Cube::operator!= (Cube& cube){// != operator 
	for(int i = 0; i<dim48; i++){
		if(cube.colors[i] != this->colors[i]){
			return true;
		}
...
input: string 
output: void
appends a string at the beginning of the moves[] vector
*/
...
input: string 
output: void
appends a string at the end of the moves[] vector
*/
...
/*
input: none
output: cube instance
changes the colors of the intial state of the cube accordingly, returns the updated cube object  
*/
Cube Cube::R(){  
...
/*
input: array with dimension=48
output: void
updates the color[] array of a cube instance
*/
...
/*
input: empty array with dimension=48
output: void
copies the color[] array of a cube instance into the empty_array[]
*/
...
/*
input: string vector with moves
output: scrambled cube
executes moves from the vector and return scrambled state
*/
...
/*
input: 4 integers between 0 - 47
output: void
the 4 integres are the indexes of 4 colors that shift when a face is moved. This function shifts the colours by 1 position for 90 degree move
*/
...
input: 4 integers between 0 - 47
output: void
the 4 integres are the indexes of 4 colors that shift when a face is moved. This function shifts the colours by 2 positions for 180 degree move
*/
...
/*
input: the move to execute as string, the previous Cube instance 
output: Cube instance with move executed
if else statements to execute the move that corresponds to the move string
*/
Cube execute_move(string move, Cube previous_state){
	if(move == "R"){
...
/*
input: string move
output: string opposite move
returns the complementary (opposite) move
*/
string return_opposite_move(string move){
	if(move == "R"){
		return "r";
...
/*
input: string move
output: string double move
returns the double move
*/
string return_double_move(string move){
	if(move == "R" || move == "r"){
		return "2R";
...
/*
input: 2 consecutive string moves from a moves[] vector, string reference to the move to change
output: bool
if the same move is repeated 3 times, it is chnaged with the opposite 90 degree move
*/
...
/*
input: empty array with dimension = 48, int last index used in the previous function, user inputs colors
output: return the new last index after 8 colors have been input
function used to insert all colors of a cube array one face at a time
*/
...
output: void
prints to terminal the vector of strings
*/
...
/*
input: empty array size =  48
output: void
creates an array with the colors of the solved rubik's cube
*/
...
prunes repeated moves, reducing the size of the array
*/
vector<string> compress_moves(vector<string> v){
...
int main(){
	...
	Cube goal_cube;
	goal_cube.add_colors(goal_array); //initialising the goal: solved rubik's cube
	...
	if(decision == 1){
		...
		cout<<" 4   5"<<endl;
		cout<<" 6 7 8"<<endl;
		last_index = insert_array(start_array, last_index);
		cout<<endl;
